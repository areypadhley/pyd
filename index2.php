       ...
       <div>
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" action="/action_page.php">
                            ...
                            <div class="form-group">
                                ...
                                <label class="control-label col-lg-3" for="email">Budget:</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" placeholder="Budget Please" required>
                                </div>
                            </div>
                             <div class="form-group">
                                <label class="control-label col-lg-3" for="email">Select Type:</label>
                                <div class="col-lg-9">
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        <input type="checkbox" class="custom-control-input" id="defaultInline1">
                                        <label class="custom-control-label" for="defaultInline1">Gaming</label>
                                    </div>
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        <input type="checkbox" class="custom-control-input" id="defaultInline2">
                                        <label class="custom-control-label" for="defaultInline2">Office</label>
                                    </div>
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        <input type="checkbox" class="custom-control-input" id="defaultInline3">
                                        <label class="custom-control-label" for="defaultInline3">College</label>
                                    </div>
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        <input type="checkbox" class="custom-control-input" id="defaultInline4">
                                        <label class="custom-control-label" for="defaultInline4">Best Budget</label>
                                    </div>
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        <input type="checkbox" class="custom-control-input" id="defaultInline5">
                                        <label class="custom-control-label" for="defaultInline5">Workstation</label>
                                    </div>

                                      <div class="custom-control custom-checkbox custom-control-inline">
                                        <input type="checkbox" class="custom-control-input" id="defaultInline5">
                                        <label class="custom-control-label" for="defaultInline5">Professional</label>
                                    </div>

                                     <div class="custom-control custom-checkbox custom-control-inline">
                                        <input type="checkbox" class="custom-control-input" id="defaultInline5">
                                        <label class="custom-control-label" for="defaultInline5">Overall</label>
                                    </div>
                           ...
                           <div class="modal-header mb-3">
                            ...
                            <div class="form-group">
                                <label class="control-label col-lg-3" for="CPU">CPU:</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="CPU" placeholder="Enter CPU Name" >
                                </div>
                            </div>
                               ...
                               <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="Motherboard" placeholder="Enter Motherboard Name" >
                                </div>
                            </div>
                               ...
                               <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="RAM" placeholder="Enter RAM Name" >
                                </div>
                            </div>
                               ...
                               <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="GPU" placeholder="Enter GPU Name" >
                                </div>
                            </div>

                               <div class="form-group">
                                <label class="control-label col-lg-3" for="Hard Disk">Hard Disk:</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="Hard Disk" placeholder="Enter Hard Disk Name" >
                                </div>
                            </div>
                               ...
                               <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="SSD" placeholder="Enter SSD Name" >
                                </div>
                            </div>
                               ...
                               <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="Power Supply" placeholder="Enter Power Supply Name" >
                                </div>
                            </div>
                               ...
                               <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="Cabinet" placeholder="Enter Cabinet Name" >
                                </div>
                            </div>
                            
                             <div class="form-group">
                                <label class="control-label col-lg-3" for="HaveWeMissedSomethings">Something Else</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="HaveWeMissedSomethings" placeholder="Another component.." >
                                </div>
                            </div>
        ...
        <div class="container shadow-lg mb-4">
            <div class="mt-3 text-center ">	
                <h1 class="pt-4 fontpt"> We Fix Devices Withcare</h1>
                <p class="fontrubik">Get your device in Fitmode with some easy steps</p>
            </div>
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption  font-weight-bold fontpt">
                            ...
                            <h2>Repair that gives life to your devie</h2>
                        </div>
                    </div>
                </div>
            ...
            <div class="container mainstep mt-4">
                <div class="row">
                    <div class="col-lg-4 col-sm-12 step text-center">
                        ...
                        <div>
                            <p style="padding-left: 68px; padding-right: 85px;" class="fontrubik">It helps us to know about problem and we will them it</p>	
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-12 step text-center">
                        <div style="padding: 30px;" class="stepicon  mx-auto " >
                        ...
                        <div class="card">
                            <div class="box">
                                <div class="content">
                                    ...
                                    <p>It helps us to know about problem and we will them it.</p>
                        ...
                        <div class="card">
                            <div class="box">
                                <div class="content">
                                    ...
                                    <p>Get your device at your home or office. Pickup , doorstep service or courier.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section>
            <div class="advantage shadow-lg">
                ...
                <div class="advantagetitle">
                    <h1 class="fontpt">Additional Benefits</h1>
                    <p class="fontrubik">Your One Stop Solution to all your Hardware and Software issues</p>
                </div>
                <div class="advimg ">
                ...
                <div class="aboutone">
                    ...
                    <p class="fontrubik fontsize18">We are fully stand behind their repairs with a full 30 days warranty 
                ...
                <div class="abouttwo">
                    ...
                    <p class="fontrubik fontsize18">Only the best parts and components are sourced by us to ensure your 
                ...
                <div class="aboutfour">
                    ...
                    <h4 class="fontpt">Low Price Guarantee</h4>

                    <p class="fontrubik fontsize18"> Getting your device repaired shouldn’t break the bank. Our low price guarantee ensures that we always offer the best price to our customers.</p>
                </div>
            </div>
        </section>
            ...
            <div class="container-fluid feedback shadow-lg mt-5" style="background-image: url('imgs/repair3.jpg') !important; opacity: 1;">
                ...
                <div class="row ">		
                    <div class="col-12 left-box">
                        ...
                        <p class="pl-3 text-center text-white fontrubik">See what our customers are saying about us</p>
                            ...
                            <div class="carousel-inner">
                                    ...
                                    <div class="card">
                                        <div class="card-header bg-white text-center border-0 ">
                                            <div class="row justify-content-center ">
                                                <div class="col"> 
                                                    <img class="align-self-center text-center rounded-circle outside img-fluid" src="https://i.imgur.com/iFxkfIU.jpg" width="110" height="110"> 
                                                </div>
                                            </div>
                                ...
                                <div class="carousel-item text-white">
                                    <div class="card">
                                        <div class="card-header bg-white text-center border-0 ">
                                            <div class="row justify-content-center ">
                                                <div class="col"> <img class="align-self-center text-center rounded-circle outside img-fluid" src="https://i.imgur.com/itiV3ML.jpg" width="110" height="110"> </div>
                                            </div>
                                            <div class="row text-center name">
                                                <div class="col">
                                ...
                                <div class="carousel-item">
                                    <div class="card">
                                        <div class="card-header bg-white text-center border-0 ">
                                            <div class="row justify-content-center ">
                                                <div class="col"> <img class="align-self-center text-center rounded-circle outside img-fluid" src="https://i.imgur.com/uuQov9u.jpg" width="110" height="110"> </div>
                                            </div>
                                            <div class="row text-center name">
                                                <div class="col">
